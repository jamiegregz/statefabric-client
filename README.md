...
TypeScript client for the StateFabric session and compacted-context APIs.

The package ships ESM and CommonJS builds from `dist`, with TypeScript declarations generated by `tsup`.
